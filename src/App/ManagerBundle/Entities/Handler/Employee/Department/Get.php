...
class Get extends HandlerManager implements Handler {
	...
	{
		$Employee = $this->em->getRepository('AppManagerBundle:Model\Employee\Department')->find($this->id);

		if ( ! $Employee)
			throw new NotFoundHttpException('Employee Department #'.$this->id.' Not Found');
