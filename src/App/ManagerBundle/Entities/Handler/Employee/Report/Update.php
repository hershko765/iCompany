...
class Update extends HandlerManager implements Handler {
	...
	protected function _execute()
	{
		...
		$employeeReport = $repo->find($this->id);
		if ( ! $employeeReport)
			throw new NotFoundHttpException('Employee Report ID #'.$this->id.' Not Found');

		$repo->hydrate($this->data, $employeeReport, Repository::PERM_UPDATE);
